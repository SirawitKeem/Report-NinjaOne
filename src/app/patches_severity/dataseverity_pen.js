...
export const getSeverityPendingSummaryData = (counts) => ({
  mainStats: [
    // เปลี่ยน label เป็น Total Pending ให้สอดคล้องกับข้อมูลที่ยังไม่ได้ติดตั้ง
    { id: 1, label: "Total Pending",   value: counts.total    ?? 0, icon: CheckCircle,  iconBg: "bg-emerald-50", iconColor: "text-emerald-600", barColor: "bg-emerald-600" },
    ...
    { id: 5, label: "Optional",        value: counts.optional ?? 0, icon: Puzzle,        
      iconBg: "bg-purple-50",       // ✅ ใช้สี purple ตามที่จดจำไว้
