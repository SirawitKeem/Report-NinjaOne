...
export default async function SoftwareSummaryInstalled() {
  try {
    // 1. ดึงข้อมูลพร้อมกัน
    ...
    // 3. รวบรวม deviceId ที่มี Software Installed อย่างน้อย 1 ตัว
    ...
    console.error("❌ SOFTWARE_IN Error:", error);
    return <div className="p-4 text-red-500">Failed to load software summary data.</div>;
  }
}