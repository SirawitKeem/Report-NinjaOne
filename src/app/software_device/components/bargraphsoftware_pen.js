...
export default async function BargraphSoftwarePending() {
  try {
    // 1. ดึงข้อมูลพร้อมกัน
    ...
    // 3. นับจำนวน Software Pending ต่อ device
    const countMap = {};
    softwareData
    ...
    // 4. Sort descending → Top 10 เครื่องที่มี Software Pending มากสุด
    ...
    return (
      <div className="w-full h-[350px] pr-10 mt-4">
        <BarGraph
          title="Top 10 Devices - Most Software Pending"
          icon={BarChart2}
          data={top10}
        />
      </div>
